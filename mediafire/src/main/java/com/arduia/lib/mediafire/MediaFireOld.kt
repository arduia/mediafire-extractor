...
object MediaFireOld{
    ...
    @JvmStatic
    fun extract(url:String):MediaFireOld{
        try {
    ...
    @JvmStatic
    fun setOnSuccessListener(listener:OnSuccessListener):MediaFireOld{
        this.onSuccessListener = listener
        return this
    }

    @JvmStatic
    fun setOnFailureListener(listener: OnFailureListener):MediaFireOld{
